...
interface EducationPeopleViewProps {
  workspaceId: string;
  config: Record<string, any>;
}

export function EducationPeopleView({ workspaceId, config }: EducationPeopleViewProps) {
    ...
    <div className="px-4 sm:px-6 py-6 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          <Link href={`/workspaces/${workspaceId}/add-students`} className="flex-1 sm:flex-none">
            <button
